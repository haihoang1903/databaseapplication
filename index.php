...
$exct = "select id, max(bidshistory.bids) as bids, auctionproducts.cid as seller, bidshistory.customer_id as bidder from auctionproducts
join bidshistory
...
if(isset($_POST['asc'])){
  if($_POST['asc']=='price'){
    $exct = 'select auctionproducts.id as id, auctionproducts.closing_time as closing_time,auctionproducts.auction_name as auction_name ,auctionproducts.minimum_price as minimum_price, ifnull(max(bidshistory.bids),auctionproducts.minimum_price) as mx,ifnull(count(*),0) as bidnum from auctionproducts
